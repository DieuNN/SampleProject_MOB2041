 ...
 * Use the [CallCardManagementFragment.newInstance] factory method to
...
class CallCardManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CallCardManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CallCardManagementFragment().apply {
