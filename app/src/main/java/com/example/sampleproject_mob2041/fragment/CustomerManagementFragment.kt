 ...
 * Use the [CustomerManagementFragment.newInstance] factory method to
...
class CustomerManagementFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CustomerManagementFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CustomerManagementFragment().apply {
